...
ggsave(snakemake@output[[1]], p1, width = 8, height = 6)
...
ggsave(snakemake@output[[2]], p2, width = 8, height = 6)
...
ggsave(snakemake@output[[3]], p3, width = 8, height = 6)
...
ggsave(snakemake@output[[4]], p4, width = 8, height = 6)
...
ggsave(snakemake@output[[5]], p5, width = 8, height = 6)
