# multiparous, IPI ===== plots --> 1 PFD file =========
library(data.table)
library(dplyr)
library(broom)
library(ggplot2)

#pdf("results/summary/ipi_interaction_plots.pdf", width = 8, height = 6)
...
write.csv(interaction_results, snakemake@output[["csv"]], row.names = FALSE)
